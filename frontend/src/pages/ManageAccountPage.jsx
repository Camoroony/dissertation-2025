...
function ManageAccountPage() {
    ...
    <h1 className="text-6xl font-bold mb-15">Manage your <span className="text-[#2A955F]">account!</span></h1>
    <p className="text-lg">Want to change any of your account details?</p>
    <p className="text-lg">You can update your details below!</p>
    </div>
